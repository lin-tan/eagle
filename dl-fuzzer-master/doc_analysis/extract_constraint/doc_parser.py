...
class Parser:
    ...
    def match_default(self, default_map=None, stop=False):
        ...
        for p in pat.pat_dict['pat']:
            ...
            if nval_group and pat.pat_dict['pat'][p].get('dependent', False):
                ...
                for nv in nval_group:
                    ...
                    if ntype['plural_map'] or ntype['tensor_t_map'] or ntype['structure']:
                        update_ndim = False
                    else:
                        update_ndim = True
    ...
    def parse_descp(self, pat, stop=False, cat = 'descp'):
    ...
    def map_doc_dtype(self, pat, stop=False):
